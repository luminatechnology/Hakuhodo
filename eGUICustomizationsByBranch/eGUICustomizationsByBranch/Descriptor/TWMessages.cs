...
namespace eGUICustomizations.Descriptor
{
    ...
    public static class TWMessages
    {
        ...
        public const string GenGUINbr      = "Generate GUI";
        ...
        public const string TaxNbrLenNot8          = "Tax Number Must Be 8 Characters.";
        public const string TaxNbrWarning          = "Tax Number Might Be Wrong, Please Check Again.";
        ...
        public const string PrintGUIInvRpt         = "Print GUI Invoice";
        public const string PrintGUICRMRpt         = "Print GUI Credit Note";
        public const string GUIPrintedLineDet      = "GUI Printed Line Details";
    }
}

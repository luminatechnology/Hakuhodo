...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
        TypeName="eGUICustomizations.Graph.TWNGUIPrefMaint" PrimaryView="GUIPreferences">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView SyncPosition="True" ID="form" runat="server" DataSourceID="ds" DataMember="GUIPreferences" Width="100%" AllowAutoHide="false">
		<Template>
			...
			<px:PXSelector runat="server" ID="CstPXSelector30" DataField="GUI3CopiesManNumbering" AllowEdit="True" />
			...
			<px:PXLayoutRule ControlSize="M" LabelsWidth="XM" runat="server" ID="CstPXLayoutRule7" StartRow="True" ></px:PXLayoutRule>
			<px:PXLayoutRule runat="server" ID="CstPXLayoutRule9" StartGroup="True" GroupCaption="Registration" ></px:PXLayoutRule>
			<px:PXCheckBox runat="server" ID="CstPXCheckBox27" DataField="EnableWHT" AlignLeft="true" ></px:PXCheckBox>
			<px:PXNumberEdit runat="server" ID="CstPXNumberEdit28" DataField="SecGenerationNHIPct" ></px:PXNumberEdit>
			<%--<px:PXTextEdit runat="server" ID="CstPXTextEdit29" DataField="WHTTaxAuthority" ></px:PXTextEdit>
			...
			<px:PXTextEdit runat="server" ID="CstPXTextEdit15" DataField="ZeroTaxCntry" ></px:PXTextEdit>
			...
			<px:PXLayoutRule runat="server" ID="CstPXLayoutRule16" StartRow="True" ControlSize="M" LabelsWidth="XM"></px:PXLayoutRule>
